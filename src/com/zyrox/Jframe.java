...
import com.zyrox.client.ResourceLoader;
...
public class Jframe extends Client implements ActionListener {
	...
	public void initializeMenuBar() {
		 ...
		 * Create our buttons
		 */
		JButton homeButton = createButton("Home", "House_icon.png", "Open the official Zyrox homepage.");
		JButton forumsButton = createButton("Forums", "forums.png", "Open the official Zyrox forums.");

		JButton knowledgeBaseButton = createButton("Knowledge Base", "3366503.gif", "Open the Zyrox Knowledge Base on the forums.");
		JButton storeButton = createButton("Store", "cart_icon.gif", "Open the official Zyrox store.");
		JButton voteButton = createButton("Vote", "Small-checkmark.png", "Open the official Zyrox voting page.");
		JButton scoresButton = createButton("Hiscores", "hiscores.png", "Open the official Zyrox Hiscores");

		JButton tsButton = createButton("Join Discord", "discord.png", "Join the Zyrox discord.");
...
//		menuPanel.add(tsButton);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			if (cmd != null) {
				if (cmd.equals("Home")) {
					openURL("http://www.Zyrox.io");
				} else if (cmd.equals("Forums")) {
					openURL("https://Zyrox.io/forums/");
				} else if (cmd.equals("Knowledge Base")) {
					openURL("https://Zyrox.io/forums/");
				} else if (cmd.equals("Store")) {
					openURL("https://Zyrox.io/store/");
				} else if (cmd.equals("Vote")) {
					openURL("https://Zyrox.io/vote/");
				} else if (cmd.equals("Hiscores")) {
					openURL("https://Zyrox.io/hiscores/");
