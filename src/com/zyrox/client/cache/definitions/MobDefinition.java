...
public final class MobDefinition {
    ...
    public static MobDefinition forID(int i) {
        ...
        switch (i) {
            ...
            case 132:
                npc.name = "Blitz";
                npc.description = "A master attacker of Zyrox.";
                npc.combatLevel = 913;
                npc.actions = new String[5];
                npc.actions[1] = "Attack";
            ...
            case 133:
                npc.name = "Cobra";
                npc.description = "A master mager of Zyrox.";
                npc.combatLevel = 903;
                npc.actions = new String[5];
                npc.actions[1] = "Attack";
            ...
            case 135:
                npc.name = "Fear";
                npc.description = "A master ranger of Zyrox.";
                npc.combatLevel = 844;
                npc.actions = new String[5];
                npc.actions[1] = "Attack";
                npc.models = new int[9];
		...
		case 1385:
            ...
            case 2579:
                npc.name = "Max";
                npc.description = "He's mastered the many skills of Zyrox.";
                npc.combatLevel = 138;
                npc.actions = new String[5];
