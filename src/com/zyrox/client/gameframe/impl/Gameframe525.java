package com.zyrox.client.gameframe.impl;
...
public class Gameframe525 implements Gameframe {

	private int[] TAB_DRAW = {0, 1, 2, 14, 3, 4, 5, 6, 15, 8, 9, 7, 11, 12, 13, 16};
	private int[] TAB_POS = {0, 30, 60, 90, 120, 150, 180, 210, 0, 30, 60, 90, 120, 150, 180, 210};
	private int[] SIDEICONS_TAB = {0, 1, 2, 14, 3, 4, 5, 6, 15, 8, 9, 7, 11, 12, 13, 16};
	//private int[] SIDEICONS_POSITION_X = {8, 37, 67, 97, 127, 159, 187, 217, 7, 38, 69, 97, 127, 157, 189, 217};
	...
	public Gameframe525(Client client, boolean fixed, int currentTab) {
		this.client = client;
		this.fixed = fixed;
	...
	public void processTabAreaClick() {
		...
		if (fixed) {
			...
			if (client.clickMode3 == 1) {
				if (client.clickInRegion(positionX, positionY, 559, positionY + 36) && client.tabInterfaceIDs[0] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 0;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(560, positionY, 593, positionY + 36) && client.tabInterfaceIDs[1] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 1;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(594, positionY, 625, positionY + 36) && client.tabInterfaceIDs[2] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 2;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(625, positionY, 660, positionY + 36) && client.tabInterfaceIDs[3] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 3;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(660, positionY, 694, positionY + 36) && client.tabInterfaceIDs[4] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 4;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(694, positionY, 725, positionY + 36) && client.tabInterfaceIDs[5] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 5;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(725, positionY, 763, positionY + 36) && client.tabInterfaceIDs[6] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 6;
					Client.tabAreaAltered = true;
				}
				positionY = 464;
				if (client.clickInRegion(positionX, positionY, 559, positionY + 36) && client.tabInterfaceIDs[15] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 15;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(560, positionY, 593, positionY + 36) && client.tabInterfaceIDs[8] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 8;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(594, positionY, 625, positionY + 36) && client.tabInterfaceIDs[9] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 9;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(625, positionY, 660, positionY + 36) && client.tabInterfaceIDs[7] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 7;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(660, positionY, 694, positionY + 36) && client.tabInterfaceIDs[11] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 11;
					Client.tabAreaAltered = true;
				}

				if (client.clickInRegion(694, positionY, 725, positionY + 36) && client.tabInterfaceIDs[5] != 12) {
					Client.needDrawTabArea = true;
					currentTab = 12;
					Client.tabAreaAltered = true;
				}
				if (client.clickInRegion(725, positionY, 763, positionY + 36) && client.tabInterfaceIDs[14] != -1) {
					Client.needDrawTabArea = true;
					currentTab = 14;
					Client.tabAreaAltered = true;
				}
...
// Moneypouch hover
		...
		if (fixed) {
			int positionX = Client.clientWidth - 244;
			int positionY = 169, positionY2 = Client.clientHeight - 36;
			if (client.mouseInRegion(Client.clientWidth - 21, 0, Client.clientWidth, 21)) {
				client.tabHover = 10;
				processTabAreaTooltips();
			} else if (client.mouseInRegion(positionX, positionY, positionX + 30, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 0;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 30, positionY, positionX + 60, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 1;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 60, positionY, positionX + 90, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 2;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 90, positionY, positionX + 120, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 14;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 120, positionY, positionX + 150, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 3;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 150, positionY, positionX + 180, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 4;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 180, positionY, positionX + 210, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 5;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 210, positionY, positionX + 240, positionY + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 6;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX, positionY2, positionX + 30, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 15;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 30, positionY2, positionX + 60, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 8;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 60, positionY2, positionX + 90, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 9;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 90, positionY2, positionX + 120, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 7;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 120, positionY2, positionX + 150, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 11;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 150, positionY2, positionX + 180, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 12;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 180, positionY2, positionX + 210, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 13;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
			} else if (client.mouseInRegion(positionX + 210, positionY2, positionX + 240, positionY2 + 36)) {
				Client.needDrawTabArea = true;
				client.tabHover = 16;
				processTabAreaTooltips();
				Client.tabAreaAltered = true;
	...
	public void rightClickMapArea() {
		...
		if (fixed ? client.mouseX >= 562 && client.mouseX <= 586 && client.mouseY >= 143 && client.mouseY < 166
				: client.mouseX >= Client.clientWidth - 37 && client.mouseX <= Client.clientWidth - 5 && client.mouseY >= 138 && client.mouseY <= 161) {
		...
		int x = client.mouseX; // Face North on client.compass
		int y = client.mouseY;
	...
	private void drawTabs(boolean fixed) {
		if (fixed) {
			int xPos = 2;
			int yPos = 0;
	...
	private void drawSideIcons(boolean fixed) {
		if (fixed) {
			for (int index = 0; index < 15; index++) {
				...
				if (index == 14 && client.tabInterfaceIDs[SIDEICONS_TAB[index]] < 0) {
					client.tabInterfaceIDs[SIDEICONS_TAB[index]] = 15001;
				}
				int l = index == 14 ? 3 : index;
				if (client.tabInterfaceIDs[SIDEICONS_TAB[l]] != -1) {
					int x = SIDEICONS_OLD_FRAME_POSITIONX[index];
					int y = SIDEICONS_OLD_FRAME_POSITIONY[index];
					int draw = l == 3 ? 15 : l;
			...
			for (int index = 0; index < 14; index++) {
				...
				if (client.tabInterfaceIDs[tab[index]] != -1 || index == 8) {
					...
					SpriteLoader.sprites[657 + i].drawSprite((Client.clientWidth - offsetX) + positionX[index],
