...
public class Configuration {
	 ...
	 * Client information
	 */
	public final static String CLIENT_NAME = "Varrock "+gameType.getName()+" v"+new DecimalFormat("#.##").format(CLIENT_VERSION)+" - There is Still Hope.";
	...
	public static boolean ROOFS_OFF = true;
