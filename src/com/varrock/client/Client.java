...
import com.varrock.Jframe;
import com.varrock.client.DrawLine.LineType;
import com.varrock.client.cache.DataType;
import com.varrock.client.cache.definitions.Animation;
import com.varrock.client.cache.definitions.FloorDefinitionOSRS;
import com.varrock.client.cache.definitions.FloorOverlay;
import com.varrock.client.cache.definitions.FloorUnderlay;
import com.varrock.client.cache.definitions.ItemDefinition;
import com.varrock.client.cache.definitions.MobDefinition;
import com.varrock.client.cache.definitions.ObjectDefinition;
import com.varrock.client.cache.definitions.SpotAnimDefinition;
import com.varrock.client.cache.definitions.VarBit;
import com.varrock.client.cache.definitions.Varp;
import com.varrock.client.cache.download.CacheDownloadType;
import com.varrock.client.cache.download.CacheDownloader;
import com.varrock.client.cache.maps.OldschoolMaps;
import com.varrock.client.cache.node.Deque;
import com.varrock.client.cache.node.Node;
import com.varrock.client.content.*;
import com.varrock.client.content.LoginScreen.CharacterFile;
import com.varrock.client.content.auction_house.AuctionHouseItem;
import com.varrock.client.content.auction_house.AuctionHouseManager;
import com.varrock.client.content.boxes.BoxRewards;
import com.varrock.client.content.boxes.LootBox;
import com.varrock.client.content.creation_ci.CreationCI;
...
import com.varrock.client.content.teleport.TeleportManager;
import com.varrock.client.content.youtube.YouTubeManager;
import com.varrock.client.content.youtube.YouTubeVideo;
import com.varrock.client.gameframe.Gameframe;
import com.varrock.client.gameframe.impl.Gameframe525;
import com.varrock.client.gameframe.impl.Gameframe592;
import com.varrock.client.gameframe.impl.GameframeOSRS;
import com.varrock.client.graphics.FadingScreen;
import com.varrock.client.interfaces.InterfaceConstants;
import com.varrock.client.interfaces.NpcDisplayModel;
import com.varrock.client.interfaces.PendingInterfaceModule;
import com.varrock.client.login.LoginScreenHoverState;
import com.varrock.client.particles.Particle;
import com.varrock.client.particles.ParticleDefinition;
import com.varrock.client.security.JSerial;
import com.varrock.client.security.MacAddress;
...
//            }
        ...
        if (super.clickMode3 == 1) {
            if (super.saveClickX >= x[0] && super.saveClickX <= x[0] + 56 && super.saveClickY >= clientHeight - 23
                ...
                if (getClientSize() != 0) {
                    ...
                    && super.saveClickY <= clientHeight) {
                launchURL("https://varrock.io/forums/");
                pushMessage("We've attempted to open varrock.io/forums/ for you.", 0, "");
            }
            if (!showChat) {
                cButtonCPos = -1;
            }
    ...
    private void doAction(int i) {
        ...
        if(clickType == 151011) {
            launchURL("https:/varrock.io/store/");
            return;
        }
                    ...
                    if (inputString.startsWith("::gameframe")) {
                        ...
                        switch (args[1]) {
                            case "0":
                                ...
                                break;
                            case "1":
                                gameFrame = new GameframeOSRS(this, gameFrame.getFixed(), gameFrame.getCurrentTab());
                                break;
                            case "2":
                                gameFrame = new Gameframe525(this, gameFrame.getFixed(), gameFrame.getCurrentTab());
                                break;
                        }
                        needDrawTabArea = true;
                    }
    ...
    public void login(String username, String password, String authCode, boolean flag) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            if (loginCode == 2) {
                ...
                RICH_PRESENCE.updateDetails("Varrock.io");
                itemSelected = 0;
                spellSelected = 0;
                loadingStage = 0;
                currentSound = 0;
            ...
            if (loginCode == 6) {
                ...
                showCaptcha = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock is currently being updated.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 7) {
                ...
                showCaptcha = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock is currently busy.", "Please try again."};
                return;
            }
            if (loginCode == 8) {
                showTwoFactorAuth = false;
                showCaptcha = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock's login server is down.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 9) {
            ...
            if (loginCode == 23) {
                showTwoFactorAuth = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock is currently being launched.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 27) {
            ...
            if (loginCode == 30) {
                showTwoFactorAuth = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock client has been updated!",
                        "Restart your client!"};
                return;
            }
            if (loginCode == 40) {
            ...
            if (loginCode == 41) {
                showTwoFactorAuth = false;
                loginScreenCursorPos = 0;
                loginMessages = new String[]{"Varrock is not released yet."};
                return;
            }
            if (loginCode == 32) {
...
//        onDemandFetcher.dump(OSRS_MAP_IDX);
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading Varrock", 30, k);
            k += 50;
        ...
        if (spritesLoadingError) {
            ...
            k += 30;
            g.drawString("https://varrock.io", 30, k);
        }
    }
...
/*                                if (child.getShowChangeExclamation() != null && child.getShowChangeExclamation()[index]) {
    ...
    private void connectToUpdateServer() {
        ...
        while (expectedCRCs[8] == 0) {
            ...
            setLoadingText(10, "Connecting to Varrock...");
            try {
                ...
                if (!showTwoFactorAuth) {
                    ...
                    switch(loginScreenHoverState) {
                        ...
                        case STORE_QUICK_LINK:
                            Client.launchURL("https://Varrock.io/store/");
                            break;
                        case VOTE_QUICK_LINK:
                            Client.launchURL("https://Varrock.io/vote/");
                            break;
                        case FORUMS_QUICK_LINK:
                            Client.launchURL("https://Varrock.ioforums/");
                            break;
    ...
    private void renderWorld() {
        ...
        if (alertBoxTimer > 0) {
            ...
            newBoldFont.drawCenteredString("Varrock", 12 + (486 / 2), 275, 0xFF981F, 0, false);
