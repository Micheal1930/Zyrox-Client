...
public class FloorDefinitionOSRS {
	...
	public static void unpackConfig(CacheArchive streamLoader) {
		ByteBuffer buffer = ByteBuffer.wrap(streamLoader.getDataForName("flo3.dat"));

		//FileOperations.WriteFile(signlink.findcachedir() + "flo3.dat", streamLoader.getDataForName("flo3.dat"));
