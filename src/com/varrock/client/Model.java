...
import com.varrock.client.particles.ParticleAttachment;
...
public class Model extends Animable {
    ...
    public Model(int modelId, DataType dataType) {
        ...
        if (is[is.length - 1] == -1 && is[is.length - 2] == -1 || modelId == 70957)
        ...
        if(modelId == 45201 || modelId == 45194 || modelId == 72501 || modelId == 72502) {
            downscale();
        }
...
//		System.out.println("Applying NPC transformation flag --> " + i + " OSRS: " + dataType);
    ...
    public void printColors(int id) {
        System.out.println(face_color);
        if (face_color != null) {
            for (int k = 0; k < numberOfTriangleFaces; k++) {
                System.out.println("Model colors for id " + id + ": " + face_color[k]);
            }
        }
    }
